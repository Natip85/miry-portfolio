...
export default function FeaturedPage() {
  ...
  return (
    <div className="relative h-screen ">
      ...
      <div className="p-2 items-center flex flex-col justify-center h-full gap-6">
        <p className="tracking-wider text-center text-2xl sm:text-4xl md:text-6xl my-10 text-white z-40">
          FEATURED PIECES
        </p>
